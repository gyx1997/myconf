<?php
    ...
    class Scholar extends \myConf\BaseService {
        ...
        public function get_by_email(string $email) : array {
            return $this->Models->Scholar->get_by_email($email);
        }
         ...
         * @return int
         */
        public function add_new(string $email, string $first_name = '', string $last_name = '', string $chn_full_name = '', string $institute = '', string $department = '', string $address = '', string $prefix = '') : int {
