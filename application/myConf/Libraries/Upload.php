...
class Upload
{
     ...
     */
    public static function parse_upload_file(string $field, string $new_file_name, string $path_to_store, bool $use_original_ext = true): array
    {
        $file = $_FILES[$field];
        self::_check_upload_error($field);
        ...
        return array('original_name' => $file['name'], 'stored_name' => $stored_name, 'file_size' => $file['size'], 'mime_type' => $file['type']);
    }
     ...
     * @throws \myConf\Exceptions\FileUploadException
     */
    public static function get_original_name(string $field): string
    {
        self::_check_upload_error($field);
     ...
     * @throws \myConf\Exceptions\FileUploadException
     */
    private static function _check_upload_error(string $field): void
    {
