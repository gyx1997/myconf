...
class Avatar
{
     ...
     */
    public static function parse_avatar(int $user_id, string $avatar_field): string
    {
        //检查文件夹是否存在
        ...
        $full_name = \myConf\Libraries\Upload::parse_upload_file($avatar_field, strval($user_id), $base_path)['stored_name'];
